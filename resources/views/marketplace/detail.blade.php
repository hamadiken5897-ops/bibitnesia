        ...
        <div class="product-detail-wrapper">
                ...
                <div class="product-info">
                    ...
                    <div class="seller-info">
                        ...
                        <div class="seller-details">
                            ...
                            <p><i class="fas fa-map-marker-alt"></i> {{ $produk->lokasi_penjual }} | <i class="fas fa-phone"></i> {{ $produk->kontak_penjual }}</p>
                        </div>
                    </div>
            ...
            <div class="related-products">
                ...
                <div class="related-grid">
                    ...
                    <div class="related-card" onclick="window.location.href='{{ route('marketplace.show', $item->id_produk) }}'">
                        <img src="{{ $item->gambar_1 ? asset('storage/' . $item->gambar_1) : 'https://via.placeholder.com/300x200' }}" alt="{{ $item->nama_produk }}">
