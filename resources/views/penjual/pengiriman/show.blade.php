...
<div class="page-heading">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('penjual.pengiriman.index') }}" class="btn btn-secondary">
...
<div class="page-content">
    <div class="row">
        ...
        <!-- Detail Entitas (Pembeli, Alamat) -->
        <div class="col-md-8">
            <div class="card h-100">
                <div class="card-body">
                    <h5 class="card-title mb-4">Tujuan Pengiriman</h5>
        ...
        <div class="col-md-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <hr>
                    <span class="text-muted d-block mb-2">Item Produk (Toko Anda):</span>
                    <ul class="list-unstyled">
                        @foreach($pengiriman->pesanan->detailPesanan as $detail)
                            @if($detail->produk && $detail->produk->id_penjual == auth()->user()->penjual->id_penjual)
